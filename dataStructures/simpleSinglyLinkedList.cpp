...
class List{
    ...
    int pop(){
        if(isEmpty()){ //can not handle undeflow otherwise good
            //throw "empty list";
            return -1;
...
int main(){
    ...
    ls.printList(); // 8 20 30

    ls.addLast(40);
    ls.addLast(50);

    ls.printList(); // 8 20 30 40 50
    
    ls.pop();
    
    ls.printList(); // 20 30 40 50

    cout<<"20 at: "<<ls.search(20)<<endl;// 0
    cout<<"30 at: "<<ls.search(30)<<endl; //1
