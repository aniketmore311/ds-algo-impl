...
int partition(int arr[],int lo,int hi){ //partitions the array and returns the pivot index
    int i,j;
...
void quickSort(int arr[], int start, int end){ //here index is the last elemnt included its n-1 not n
